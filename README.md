...
![A white horse galloping across a golden wheat field at sunset, generated by mad-cli](docs/demo.gif)

> `mad run --prompt "a majestic white horse galloping across a golden
> wheat field at sunset, cinematic wide shot, warm light, gentle wind"`
> — 31.9s of GPU time on a RunPod `ADA_24` (RTX 4090), end to end.
