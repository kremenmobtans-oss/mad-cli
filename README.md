...
![A drone shot rising over a foggy alpine lake at sunrise, generated by mad-cli](docs/demo.gif)

> `mad run --prompt "a drone shot rising over a foggy alpine lake at
> sunrise"` — 33.3s of GPU time on a RunPod `ADA_24` (RTX 4090), end to
> end.
